(function () {
    ...
    function renderQuickInfo(quote) {
        ...
        quick.innerHTML = [
            ...
            '</div>',
            '</div>',
            '<div class="modern-route-summary">',
            '<div><span>Pickup</span><strong>' + escapeHtml(collection) + '</strong></div>',
            '<div><span>Drop-off</span><strong>' + escapeHtml(delivery) + '</strong></div>',
            '<div><span>Pickup movers</span><strong>' + escapeHtml(pickupMovers) + '</strong></div>',
            '<div><span>Delivery movers</span><strong>' + escapeHtml(deliveryMovers) + '</strong></div>',
            '</div>',
